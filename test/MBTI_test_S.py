...
grade_chosen['values'] = ('초1', '초2', '초3', '초4', '초5', '초6', '중1', '중2', '중3', '고1', '고2', '고3', '일반인')
...
scr1 = scrolledtext.ScrolledText(resultLabel1, width=30, height=2, wrap=tk.WORD)
scr1.grid(column=0, row=0, sticky='WE', columnspan=2)   

scr2 = scrolledtext.ScrolledText(resultLabel2, width=scrol_w, height=scrol_h, wrap=tk.WORD)
scr2.grid(column=0, row=0, sticky='WE', columnspan=2)   

scr3 = scrolledtext.ScrolledText(resultLabel3, width=scrol_w, height=scrol_h, wrap=tk.WORD)
