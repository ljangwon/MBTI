...
# Q1  : E,  I    Q2 :  S, N     Q3 :  T, F      Q4 : J, P  
    ...
    if R1a_score > R1b_score :
        intention += R1a_score - R1b_score
        MBTI_result += 'E'
    elif R1a_score == R1b_score :
        MBTI_result += 'E(I)'
    else :
        intention += R1b_score - R1a_score
        MBTI_result += 'I'
        
    if R2a_score > R2b_score :
        intention += R2a_score - R2b_score
        MBTI_result += 'S'
    elif R2a_score == R2b_score :
        MBTI_result += 'S(N)'
    else :
        intention += R2b_score - R2a_score        
        MBTI_result += 'N'

    if R3a_score > R3b_score :
        intention += R3a_score - R3b_score        
        MBTI_result += 'T'
    elif R3a_score == R3b_score :
        MBTI_result += 'T(F)'        
    else :
        intention += R3b_score - R3a_score        
        MBTI_result += 'F'
        
    if R4a_score > R4b_score :
        intention += R4a_score - R4b_score        
        MBTI_result += 'J'
    elif R3a_score == R3b_score :
        MBTI_result += 'J(P)' 
    else :
        intention += R4b_score - R4a_score        
        MBTI_result += 'P'
